...
export default {
  ...
  safelist: [
    ...
    'border-card-outline-black',
    'border-card-outline-white',
    'border-card-outline-light-grey',
    'border-card-outline-dark-grey',
    'border-card-outline-red',
    'border-card-outline-yellow',
    'border-card-outline-blue',
    'border-card-outline-orchid',
    'border-card-outline-orange',
    'border-card-outline-purple',
    'bg-card-dark-grey',
    'bg-pool-table',
    'bg-poker-table',
    'bg-casino-night',
