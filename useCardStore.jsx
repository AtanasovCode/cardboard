  ...
  persist(
    (set, get) => ({
      ...
      backgroundStyles: [
        ...
        { name: "Luxury Black", background: "bg-luxury-black", handleClick: () => get().changeBackgroundStyle("Luxury Black") },
        ...
        { name: "Pure Black", background: "bg-black", handleClick: () => get().changeBackgroundStyle("Pure Black") },
